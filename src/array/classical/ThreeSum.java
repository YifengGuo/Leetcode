 ...
 *         that sum to the given target number. Return all the triple of values
 *         that sums to target.
 * 
 *         Assumptions
 * 
 *         The given array is not null and has length of at least 3 No duplicate
 *         triples should be returned, order of the values in the tuple does not
 *         matter Examples
 * 
